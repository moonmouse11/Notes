...
- `git branch --sort=-committerdate` - сортирует вывод веток по дате.
...
***
## Basics
**Git** — система контроля версий, то есть хранилище истории разработки проекта.
**Репозиторий (repository)** — место, где хранятся и поддерживаются какие-либо данные. Репозиторий может быть локальным и удалённым.
